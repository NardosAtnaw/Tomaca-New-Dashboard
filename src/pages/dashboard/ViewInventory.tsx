        ...
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="right">Inventory Description</StyledTableCell>
              <StyledTableCell align="right">Inventory Price</StyledTableCell>
              ...
              <StyledTableCell align="right">Inventory Image</StyledTableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {rows.map((row) => (
